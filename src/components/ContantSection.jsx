        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    ...
                    <div className="place-y-6 justify-center ">
                        ...
                        <div className="flex  items-start space-x-4 ">
                            ...
                            <div>
                                ...
                                <a href="mailto:boradnensi112@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">boradnensi112@gmail.com </a>
                        ...
                        <div className="flex  items-start space-x-4 ">
                            ...
                            <div>
                                ...
                                <a href="tel:9510649466" className="text-muted-foreground hover:text-primary transition-colors"> 9510649466 </a>
                        ...
                        <div className="flex  items-start space-x-4 ">
                            ...
                            <div>
                                ...
                                <a className="text-muted-foreground hover:text-primary transition-colors"> 83,Shreenath Society,Ahmedabad </a>
